...
public class GlobalException {
    ...
    public ApiResponse<String> handleInvalidTimeRangeException(InvalidTimeRangeException ex) {
        log.error("Invalid time range exception: {}", ex.getMessage());
        return ApiResponse.fail(501, ex.getMessage());
    }
}
